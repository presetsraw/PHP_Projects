<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                ...
                                <h6 class="title">Saksham Sharma(Presetsraw)</h6>
                                <small class="info">MCA Student</small>
                            </div>
                            <!-- /.user-info -->
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li>
                                        <a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Admin Dashboard</span> </a>
