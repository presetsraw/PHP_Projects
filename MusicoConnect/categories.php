...
<title>Socialized Network&trade; - <?php echo $display['firstname'] . " " . $display['lastname'] ?>  - Powered by Quiambao Systems Network&trade;</title>	
