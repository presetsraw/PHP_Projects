...
<br /><br /><?php 
echo '<a href=memberinfo2.php?id=' . $id . '><img src="' . $row['image'] . '" width=30 height=50 class="framed" style="float:left; margin-left:6px; margin-top: -4px; margin-bottom: 7px;" /></a>';
echo '&nbsp;';
echo '<a href=memberinfo2.php?id=' . $id . '><span id="ngalan">' . $final_fname . '&nbsp;';
